  ...
  if (category === "Voucher") {
    ...
    if (container > 0 && cup === 0) {
      ...
      if (container > 0 && cup === 0) {
        return (
          <View style={styles.icon}>
            <Text style={[styles.iconText, {color: "green"}]}>-{container}</Text>
...
function ListItem({ item }) {
    ...
    return (
      <View style={styles.listContainer}> 
        <View style={styles.listText}> 
          <Text>{item.date}</Text>
          <Text>{item.location}: {item.storeName}</Text>
        </View>
        <View style={styles.listIconWrapper}> 
          <RenderIcon category={item.category} container={item.container} cup={item.cup} />
        </View>
      </View>
    )
  ...
  } else if(item.category === "Item" || item.category === "Voucher" || item.category === "Food") {
    return (
      <View style={styles.listContainer}> 
        <View style={styles.listText}> 
          <Text>{item.date}</Text>
          <Text>{item.category}: {item.reward}</Text>
        </View>
        <View style={styles.listIconWrapper}> 
  ...
  return (
    <ScrollView> 
      <View style={styles.container}>
        ...
        {/*Top bar*/}
        <View style={[styles.contentContainer, styles.shadow, {marginTop: 20}]}>
